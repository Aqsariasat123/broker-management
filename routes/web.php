...
Route::prefix('tasks')->group(function () {
    ...
    // ✅ FIXED: Use CalendarController for updates from calendar
    Route::match(['PUT', 'PATCH', 'POST'], '/{task}', [CalendarController::class, 'update'])->name('tasks.update');
...
Route::get('/followups/export', [FollowupController::class, 'export'])->name('followups.export');
Route::post('/followups/save-column-settings', [FollowupController::class, 'saveColumnSettings'])->name('followups.save-column-settings');
Route::get('/followups/{followup}/edit', [FollowupController::class, 'edit'])->name('followups.edit');  // ← NEW
Route::put('/followups/{followup}', [FollowupController::class, 'update'])->name('followups.update');   // ← NEW
Route::delete('/followups/{followup}', [FollowupController::class, 'destroy'])->name('followups.destroy'); // ← NEW
Route::post('/followups/{followup}/status', [FollowupController::class, 'updateStatus'])->name('followups.update-status');
...
Route::get('/documents/{document}/view', function($documentId) {
