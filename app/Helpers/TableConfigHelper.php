    ...
    public static function getConfig($module)
    {
        $configs = [
            ...
            'policies' => [
                ...
                'default_columns' => [
                    'policy_no','insurer','policy_class','policy_plan','start_date',
                    'end_date','total_premium','base_premium','insured_item','policy_status'
                ],
            ...
            'commissions' => [
                ...
                'default_columns' => [
                    ...
                    'payment_status','amount_received','date_received','statement_no','date_due','mode_of_payment','variance','reason','cnid'
                ],
                'mandatory_columns' => ['policy_code', 'client_name', 'cnid'],
                'column_definitions' => [
                    'policy_code' => 'Policy Number',
                    'client_name' => "Client's Name",
                    'insurer' => 'Insurer',
                    'grouping' => 'Grouping',
                    'basic_premium' => 'Basic Premium',
                    'rate' => 'Rate',
                    'amount_due' => 'Amount Due',
                    'payment_status' => 'Com Status',
                    'amount_received' => 'Amount Rcvd',
                    'date_received' => 'Date Rcvd',
                    'statement_no' => 'State No',
                    'date_due' => 'Date Due',
