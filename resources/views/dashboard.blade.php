...
<div class="charts">
  ...
  {{-- FIXED: Date Range Layout matching image --}}
      <div class="date-range-container">
        <div class="date-range-box">
          <span class="label">From :</span>
          <div class="fields">
            <input type="text" value="{{ $yearStart->format('j-M-y') }}" readonly class="date-field">
            <input type="text" value="{{ number_format($totalIncome ?? 0, 2) }}" readonly class="amount-field">
          </div>
        </div>
        <div class="date-range-box">
          <span class="label">To :</span>
          <div class="fields">
            <input type="text" value="{{ $yearEnd->format('j-M-y') }}" readonly class="date-field">
            <input type="text" value="{{ number_format($totalExpense ?? 0, 2) }}" readonly class="amount-field">
          </div>
        </div>
      </div>
